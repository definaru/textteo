...
.arrow-back-btn-and-summary-original{
padding-left: 2%;
    }
...
#register .custom-popup .modal-body {
  padding: 30px;
}

#register .custom-popup input::placeholder {
  color: #bbb;
}
...
#register .custom-popup .btn-warning:hover {
  background-color: #e0a800;
}

#register .custom-popup .btn i {
  margin-right: 5px;
}
...
/* Submit button */
#change_password .submit-section {
  text-align: center;
}
                ...
                <nav aria-label="breadcrumb" class="page-breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><?php
                                                                                ...
                                                                                ?></li>
                    <li class="breadcrumb-item"><a href="<?php echo base_url().'/doctor-preview/'.$doctors['username']; ?>"><?php echo $language['lg_dr']. libsodiumDecrypt($doctors['first_name']).' '.libsodiumDecrypt($doctors['last_name']) ?? ""; ?></a></li>
    ...
    $(document).ready(function(){
        ...
        async function saveChangesAppointment(){
            ...
            if(petSelected != null && sessionAppointment != null && amountInfo != null){
                ...
                $scheduleDateHtml = !sessionAppointment?  '<input type="date" name="schedule_date" id="schedule_date" value="<?php echo Date('Y-m-d') ?>" min="<?php echo date("Y-m-d"); ?>">' : '<input type="hidden" name="schedule_date" id="schedule_date" value="<?php echo Date('Y-m-d') ?>" min="<?php echo date("Y-m-d"); ?>">';
