		...
		<div class="row">
			...
			<div class="col-md-7 col-lg-8 col-xl-9">
				...
				if ($user_detail && $user_detail['is_updated'] == '0') {
					$warn = $language['lg_this_is_a_warni'] ?? "This is a warning alert for profile update";
					$click = $language['lg_click_here1'] ?? "Click Here";
					$give = $language['lg_give_it_a_click'] ?? "Give it a click if you update.";
				...
				if ($user_detail && $user_detail['is_verified'] == '0') {
					$warn = $language['lg_this_is_a_warni1'] ?? "This is a warning alert for email verification";
					$click = $language['lg_click_here1'] ?? "Click Here";
					$give = $language['lg_give_it_a_click'] ?? "Give it a click if you update.";
					echo '<div class="alert alert-warning" role="alert">
  ...
  <div class="appointment-card">
    <div class="card-header">
      <button class="back-btn">
        <img src="<?php echo $dat[7] ?>" alt="Back">
      </button>
      <?php echo $dat[4] ?>
    </div>
    ...
    <div class="card-body-appointment">
      ...
      <div class="pet-info">
        <img src="<?php echo $dat[5] ?>" alt="Pet" class="img-fluid" width="50" height="50" />
        <div>
          <div class="pet-name"><?php echo $dat[3] ?></div>
          <div class="pet-type"><?php echo $dat[6] ?></div>
        </div>
      </div>

      <div class="appointment-date">
        <div class="label">Appointment Date</div>
        <div class="date"><?php echo $dat[2] ?></div>
      </div>
    </div>
  </div>
</div>
