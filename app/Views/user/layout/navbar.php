      ...
      <nav class="navbar navbar-expand-lg header-nav">
        <div class="navbar-header">
          <a id="mobile_btn" href="javascript:void(0);">
              <img src="<?php echo base_url() ?>assets/images/Icon svg/Interface icon/all/menu.svg" alt="Menu icon" />
          </a>
          ...
          <a  href="<?php echo base_url(); ?>login">
            <img src="<?php echo base_url() . "assets/img/login.png"; ?>" class="mobile-login-button" style="width:30px; border: 1px solid #C3C3C3;border-radius: 4px;background: #fff;cursor: pointer;text-decoration: none; width: 48px;height: 44px;" alt="Login">
          </a>
        ...
        <div class="main-menu-wrapper">
          ...
          <ul class="main-nav">
            <li <?php
             ...
             <li><a href="<?php echo base_url(); ?>#pet-problem-section" id="header-content" class="close-menu">Help now</a></li>
        <li><a href="<?php echo base_url(); ?>#review-carousel-section" id="header-content" class="close-menu">Testimonials</a></li>
        <li><a href="<?php echo base_url(); ?>#trusted-vets-section" id="header-content" class="close-menu">Our vets</a></li>
        <li><a href="<?php echo base_url(); ?>#how-it-works-section" id="header-content" class="close-menu">How it works</a></li>
        <li><a href="<?php echo base_url(); ?>#faq" id="header-content" class="close-menu">FAQ</a></li>
