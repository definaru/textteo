...
class Container_63b0ca4ec7 extends _PHPStan_690619d82\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService047(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_63b0ca4ec7 $container)
			{
	...
	public function createServiceContainer(): Container_63b0ca4ec7
	{
		return $this;
	}
