...
class Container_2ef08f47a8 extends _PHPStan_d55c4f2c2\Nette\DI\Container
{
	protected $tags = [
	...
	protected $types = ['container' => '_PHPStan_d55c4f2c2\Nette\DI\Container'];
	protected $aliases = [];

	protected $wiring = [
		'_PHPStan_d55c4f2c2\Nette\DI\Container' => [['container']],
		'PHPStan\Rules\Rule' => [
			[
				'0109',
				'0110',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			...
			'generateBaselineFile' => 'D:\xampp\htdocs\dgtdoccurenew\phpstan-baseline.neon',
			'usedLevel' => '6',
	...
	public function createService047(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_2ef08f47a8 $container)
			{
	...
	public function createService061(): PHPStan\DependencyInjection\DerivativeContainerFactory
	{
		return new PHPStan\DependencyInjection\DerivativeContainerFactory(
			...
			'6',
			'D:\xampp\htdocs\dgtdoccurenew\phpstan-baseline.neon',
			null
		);
	}
	...
	public function createServiceContainer(): Container_2ef08f47a8
	{
		return $this;
	}
