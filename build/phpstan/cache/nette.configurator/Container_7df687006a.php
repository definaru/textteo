...
class Container_7df687006a extends _PHPStan_690619d82\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService047(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_7df687006a $container)
			{
	...
	public function createServiceContainer(): Container_7df687006a
	{
		return $this;
	}
