...
class Container_8c3f015e12 extends _PHPStan_690619d82\Nette\DI\Container
{
	protected $tags = [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			...
			'scanDirectories' => [
				...
				'C:\xampp\htdocs\dgtdoccurenew\app\Config',
			],
			'parallel' => [
				'jobSize' => 20,
	...
	public function createService047(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_8c3f015e12 $container)
			{
	...
	public function createServiceContainer(): Container_8c3f015e12
	{
		return $this;
	}
