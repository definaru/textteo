...
class Container_e779b231a9 extends _PHPStan_690619d82\Nette\DI\Container
{
	protected $tags = [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			...
			'ignoreErrors' => ['#Function pcntl_open not found\.#', '#Variable \$this might not be defined\.#'],
			...
			'generateBaselineFile' => 'C:\xampp\htdocs\dgtdoccurenew\phpstan-baseline.neon',
			'usedLevel' => '6',
	...
	public function createService041(): PHPStan\Analyser\IgnoredErrorHelper
	{
		return new PHPStan\Analyser\IgnoredErrorHelper(
			$this->getService('066'),
			['#Function pcntl_open not found\.#', '#Variable \$this might not be defined\.#'],
			true
		);
	}
	...
	public function createService047(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_e779b231a9 $container)
			{
	...
	public function createService061(): PHPStan\DependencyInjection\DerivativeContainerFactory
	{
		return new PHPStan\DependencyInjection\DerivativeContainerFactory(
			...
			'6',
			'C:\xampp\htdocs\dgtdoccurenew\phpstan-baseline.neon',
			null
		);
	}
	...
	public function createServiceContainer(): Container_e779b231a9
	{
		return $this;
	}
