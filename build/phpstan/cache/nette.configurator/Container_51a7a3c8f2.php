...
class Container_51a7a3c8f2 extends _PHPStan_d55c4f2c2\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService047(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_51a7a3c8f2 $container)
			{
	...
	public function createServiceContainer(): Container_51a7a3c8f2
	{
		return $this;
	}
