...
class Container_ec0c93c7e8 extends _PHPStan_690619d82\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService047(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_ec0c93c7e8 $container)
			{
	...
	public function createServiceContainer(): Container_ec0c93c7e8
	{
		return $this;
	}
