...
class Container_f747d03d9d extends _PHPStan_d55c4f2c2\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService047(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_f747d03d9d $container)
			{
	...
	public function createServiceContainer(): Container_f747d03d9d
	{
		return $this;
	}
