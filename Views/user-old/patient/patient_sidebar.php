...
// $order_count = $this->db->where('user_notify', 0)->where('user_id', session('user_id'))->get('orders')->numRows();
$order_count = 0;
?>
			...
			<ul>
				...
				<li <?php echo ($module == 'patient' && $page == 'appoinments') ? 'class="active"' : ''; ?>>
					<a href="<?php echo base_url(); ?>appoinments">
						...
						<span><?php //echo $language['lg_appointments']; ?>Upcoming Apointment</span>
					</a>
				</li>
