...
<script src="https://maps.googleapis.com/maps/api/js?key=<?php echo !empty(settings("google_map_api")) ? libsodiumDecrypt(settings("google_map_api")) : ''; ?>&callback=initAutocomplete&libraries=places&v=weekly"></script>
