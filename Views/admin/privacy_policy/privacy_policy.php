			...
			<div class="col-md-12 col-12">
				<nav aria-label="breadcrumb" class="page-breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page"><?php echo $language['lg_privacy_policy'] ?? ''; ?></li>
					</ol>
				</nav>
				<h2 class="breadcrumb-title"><?php echo $language['lg_privacy_policy'] ?? ''; ?></h2>
			</div>
		</div>
	</div>
</div>
