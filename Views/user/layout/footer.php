        ...
        <div class="col-lg-3 col-md-6">
          <div class="footer-widget footer-about">
            ...
            <div class="footer-about-content">
              ...
              <p><?php echo ((isset($language['lg_footer_content_under'])) ? $language['lg_footer_content_under'] : ""); ?></p>
              <p><?php echo ((isset($language['lg_footer_content_mail_info'])) ? $language['lg_footer_content_mail_info'] : ""); ?></p>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="footer-widget footer-contact">
            ...
            <div class="footer-contact-info">
              ...
              <p class="mb-0" style="color:#C3C3C3">
