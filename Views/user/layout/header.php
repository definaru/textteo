...
<head>
    ...
    <title><?=$this->renderSection('title');?> | <?=!empty(settings("meta_title")) ? settings("meta_title") : "Textteo";?></title>
    ...
    ?>
    <meta http-equiv="refresh" content="<?=$timeout_tot?>;URL=<?=base_url().'user-logout';?>?timeout">
    <!-- Favicons -->
    <link rel="icon" href="/uploads/logo/1716626275_8357ec0a82c3394e6aa6.png" />
...
?>
    ...
    <div class="modal fade custom-modal" id="appoinments_details">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title"><?=isset($language['lg_appointment_det']) ? $language['lg_appointment_det'] : '';?></h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
            ...
            <ul class="info-details">
              <li>
                <div class="details-header">
                  <div class="row">
                    <div class="col-md-8">
                      <span class="title"><?=isset($language['lg_appointment_dat']) ? $language['lg_appointment_dat'] : '';?></span>
              ...
              <li>
                <span class="title"><?=isset($language['lg_appoinment_type']) ? $language['lg_appoinment_type'] : ''; ?></span>
                <span class="text type"></span>
              </li>
              <li>
                <span class="title"><?=isset($language['lg_confirm_date']) ? $language['lg_confirm_date'] : ''; ?></span>
                <span class="text book_date"></span>
              </li>
              <li>
                <span class="title"><?=isset($language['lg_paid_amount']) ? $language['lg_paid_amount'] : ''; ?></span>
