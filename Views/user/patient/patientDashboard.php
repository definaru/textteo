	...
	<div class="container mt-5 pt-5">
		<div class="row align-items-center">
			<div class="col-md-12 col-12">
				...
				<h2 class="breadcrumb-title"><?=$language['lg_dashboard'] ?? ' '; ?></h2>
			</div>
		</div>
	</div>
</div>
					...
					<div class="card-body pt-0">
						<nav class="mb-4">
							<ul class="nav nav-tabs w-100 border-0 nav-fill">
								<li class="nav-item">
									<a class="nav-link active" onclick="appoinments_table()" href="#pat_appointments" data-toggle="tab"><?=$language['lg_appointments_Schedule'] ?? " "; ?></a>
								</li>
								<li class="nav-item">
									<a class="nav-link" onclick="previous_appoinments_table()" href="#pres" data-toggle="tab"><span><?=$language['lg_appointments_Previous'] ?? " "; ?></span></a>
								</li>
								<!--<li class="nav-item">
									<a class="nav-link" onclick="medical_records_table()" href="#medical" data-toggle="tab"><span class="med-records"><?php // $language['lg_medical_records'] ?? " "; ?></span></a>
								</li>
								<li class="nav-item">
									<a class="nav-link" onclick="billings_table()" href="#billing" data-toggle="tab"><span><?php // $language['lg_billing'] ?? " "; ?></span></a>
								</li>-->
							</ul>
						</nav>
