		...
		<div class="profile-info-widget">
			...
			<div class="profile-det-info">
				<h3>
					...
					if(session('role')=='6')
					{ 
						echo ucfirst(libsodiumDecrypt($user_detail['clinicname'] == "" ? $user_detail['first_name']:$user_detail['clinicname']));
					}
					else
					{						                       
						echo $language['lg_dr'];?> <?php echo ucfirst(libsodiumDecrypt($user_detail['first_name']).' '.libsodiumDecrypt($user_detail['last_name']));
					}
					?>
				</h3>
