    ...
    if (pages == 'index') {
        ...
        $("#search_button").click(function () {
            ...
            if (search_keywords != '' && search_location != '') {
                ...
                window.location.href = base_url + 'search-veterinary?location=' + search_location + '&keywords=' + search_keywords;

            } else if (search_keywords != '') {
                window.location.href = base_url + 'search-veterinary?keywords=' + search_keywords;
            } else if (search_location != '') {
                window.location.href = base_url + 'search-veterinary?location=' + search_location;
                        ...
                        if (data.length) {
                            ...
                            if (obj.location != null) {
                                ...
                                $(obj.location).each(function () {
                                    html += '<div class="keyword-search"><a href="' + base_url + 'search-veterinary?location=' + this.location + '">' + lg_location2 + '  - ' + this.location + '</a></div>';
                                });
                        ...
                        if (data.length) {
                            ...
                            if (obj.specialist != null) {
                                ...
                                $(obj.specialist).each(function () {
                                    html += '<div class="keyword-search"><a href="' + base_url + 'search-veterinary?keywords=' + this.specialization + '">' + lg_speciality + '  - ' + this.specialization + '</a></div>';
                                });
                            ...
                            if (obj.doctor != null) {
                                $(obj.doctor).each(function () {
                                    html += '<div class="keyword-search"><a href="' + base_url + 'search-veterinary?keywords=' + this.first_name + '"><div class="keyword-img"><img src="' + this.profileimage + '" class="img-responsive"></div>' + lg_dr + ' '
                                        + this.first_name + ' ' + this.last_name +
                                        '</a><small>' + lg_specialist + ' -' + this.speciality + '</small></div>';
                                });
                    ...
                    if (response) {
                        ...
                        if (obj.data.length >= 1) {
                            ...
                            $(obj.data).each(function () {
                                ...
                                var fullname = "";
                                //if (role == 1) {
                                    fullname = lg_dr + ' ' + this.first_name + ' ' + this.last_name;
                                //}
                                // else {
                                    ...
                                    <div class="card-body p-4">
                                        ...
                                        <div class="col-9 ps-md-3" style="margin-top: -5%;">
                                            ...
                                            <h4 class="doctor-name h5" style="margin-bottom: 0;font-size:16px;font-weight:500">
                                                ...
                                                ${fullname} <i class="fas fa-chevron-right ms-1 small"></i>
                                                </a>
                                            </h4>
                                ...
                                html += '<div class="card d-none d-md-flex">' +
                                    '<div class="card-body doctor-list-search">' +
                                    '<div class="doctor-widget">' +
                                    '<div class="doc-info-left">' +
                                    '<div class="doctor-img">' +
                                    '<a href="' + base_url + 'doctor-preview/' + this.username + '">' +
                                    '<img src="' + this.profileimage + '" class="img-fluid" style="width:100px;height:100px;border-radius:12px" alt="User Image">' +
                                    '</a>' +
                                    '</div>' +
                                    '<div class="doc-info-cont">' +
                                    '<h4 class="doc-name"><a href="' + base_url + 'doctor-preview/' + this.username + '">' + fullname + '</a> ></h4>';

                                if (role == 1) {
                                    //html += '<h5 class="doc-department"><img src="' + this.specialization_img + '" class="img-fluid" alt="Speciality">' + this.speciality + '</h5>';
                                }
                                html += '<div class="rating">';
                                html += '<p style="font-weight:500;font-size:14px;color:#757575">'+ this.speciality + '</p>';
                                for (var j = 1; j <= 5; j++) {
                                ...
                                html +=
                                 '<span class="d-inline-block average-rating">(' + this.rating_count + ')</span>' +
                                    ...
                                    '<p class="doc-location" style="font-size:14px"><i class="fas fa-map-marker-alt"></i> '+ this.clinicname + '</p>' +
                                ...
                                if (login_role != 5 & login_role != 4 & login_role != 1 & login_role != 6) {
                                    html += '<div class="clini-infos">' +
                                    '<ul>' + 
                                    '<li> 1 video consultation <span style="color:#FD9720;font_size:24px; font-weight:600">' + this.amount + '</span> </li>' +
                                    '</ul>' +
                                    '</div>';
                                    html += '<a class="apt-btn" href="' + base_url + 'doctor-preview/' + this.username + '">' + lg_book_appointmen + '</a>';
                                }
                                ...
                                html += '</div>' +
                                    '</div>' +
                                    '</div>';
                                    html+='<div class="row slot-container-row" style="border-top: 1px solid #E1E1E1;">';
                                    html+='<div style="font-size:16px;font-weight:600;color:#252525; padding-left:2%"><p>Today</p></div>';
                                    html+='<div class="col-md-12 col-lg-12 col-sm-12">';
                                    html+=this.slotsToday;
                                    html+='</div>';
                                    html+='</div>';
                                    html+='</div>';
                                    html+=`
